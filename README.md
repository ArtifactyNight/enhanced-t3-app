...
This is a [T3 Stack](https://create.t3.gg/) project bootstrapped with `create-t3-app` with [Better Auth](https://better-auth.com) as Authentication Provider and [shadcn/ui](https://ui.shadcn.com/) for the UI components.
